({
    ...
    handleClick: function(cmp, event, helper) {
        ...
        cmp.find("navService").navigate({ 
            ...
            attributes: { 
                url: 'https://medtech1.my.salesforce.com/flow/Mark_Product_for_Order?ProductId=01tHr00000GLDYiIAI&&LocationId=131Hr000000zSgyIAC'
            } 
        });
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
            "url": "/flow/Mark_Product_for_Order?ProductId=01tHr00000GLDYiIAI&&LocationId=131Hr000000zSgyIAC"
        });
        urlEvent.fire();*/
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
        ...
        //urlEvent.fire();
        location.replace("/flow/Mark_Product_for_Order?ProductId=01tHr00000GLDYiIAI&&LocationId=131Hr000000zSgyIAC&retURL="+cmp.get("v.VisitId"))
    },
