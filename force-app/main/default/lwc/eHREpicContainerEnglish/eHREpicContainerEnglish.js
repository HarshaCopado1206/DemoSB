...
import { OMNIDEF } from './eHREpicContainerEnglish_def.js';
import tmpl from './eHREpicContainerEnglish.html';
import tmpl_nds from './eHREpicContainerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eHREpicContainerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
