...
import { OMNIDEF } from './eHREpicEnglish_def.js';
import tmpl from './eHREpicEnglish.html';
import tmpl_nds from './eHREpicEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eHREpicEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
