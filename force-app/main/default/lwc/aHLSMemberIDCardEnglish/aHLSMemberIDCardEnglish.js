...
import { OMNIDEF } from './aHLSMemberIDCardEnglish_def.js';
import tmpl from './aHLSMemberIDCardEnglish.html';
import tmpl_nds from './aHLSMemberIDCardEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aHLSMemberIDCardEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
