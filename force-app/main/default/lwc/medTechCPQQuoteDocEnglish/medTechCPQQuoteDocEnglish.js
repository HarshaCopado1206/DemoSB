...
import { OMNIDEF } from './medTechCPQQuoteDocEnglish_def.js';
import tmpl from './medTechCPQQuoteDocEnglish.html';
import tmpl_nds from './medTechCPQQuoteDocEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medTechCPQQuoteDocEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
