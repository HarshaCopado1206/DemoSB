...
import { OMNIDEF } from './smallGroupContractDocumentEnglish_def.js';
import tmpl from './smallGroupContractDocumentEnglish.html';
import tmpl_nds from './smallGroupContractDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smallGroupContractDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
